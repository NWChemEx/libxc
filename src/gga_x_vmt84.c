...
gga_x_vmt84_init(xc_func_type *p)
{
  ...
  assert(sizeof(gga_x_vmt84_params) <= XC_MAX_FUNC_PARAMS*sizeof(double));
  assert(p != NULL);
...
EXTERN const xc_func_info_type xc_func_info_gga_x_vmt84_pbe = {
  XC_GGA_X_VMT84_PBE,
  XC_EXCHANGE,
...
EXTERN const xc_func_info_type xc_func_info_gga_x_vmt84_ge = {
  XC_GGA_X_VMT84_GE,
  XC_EXCHANGE,
