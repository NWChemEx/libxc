...
gga_xc_oblyp_d_init(xc_func_type *p)
{
  ...
  static double par_x_b88 [2] = {0.00401, 6.0};
  static double par_c_lyp [4] = {0.05047, 0.140, 0.2196, 0.363};
...
gga_xc_opwlyp_d_init(xc_func_type *p)
{
  ...
  static double par_c_lyp [4] = {0.04960, 0.144, 0.2262, 0.346};
  static double par_x_pw91[3] = {0.00402, 0.8894/(X2S*X2S), 0.79};
...
gga_xc_opbe_d_init(xc_func_type *p)
{
  ...
  static double par_x_pbe [2] = {1.2010, 0.21198};
  static double par_c_pbe [3] = {0.04636, XC_EXT_PARAMS_DEFAULT, XC_EXT_PARAMS_DEFAULT};
