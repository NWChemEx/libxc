...
DEVICE
static const double dvc_omega_TH_FL[] = 
...
DEVICE
static const double dvc_omega_TH_FC[] = 
...
DEVICE
static const double dvc_omega_TH_FCFO[] = 
  {-0.864448e+00, +0.565130e+00, -0.127306e+01, +0.309681e+00, -0.287658e+00, +0.588767e+00,
   -0.252700e+00, +0.223563e-01, +0.140131e-01, -0.826608e-01, +0.556080e-01, -0.936227e-02,
...
DEVICE
static const double dvc_omega_TH_FCO[] = 
...
DEVICE
static const double dvc_omega_TH1[] = 
...
DEVICE
static void 
dvc_gga_xc_th1_init(xc_func_type *p)
{
  ...
  case XC_GGA_XC_TH_FL:
    params->omega = dvc_omega_TH_FL;
    break;

  case XC_GGA_XC_TH_FC:
    params->omega = dvc_omega_TH_FC;
    break;

  case XC_GGA_XC_TH_FCFO:
    params->omega = dvc_omega_TH_FCFO;
    break;

  case XC_GGA_XC_TH_FCO:
    params->omega = dvc_omega_TH_FCO; 
    break;

  case XC_GGA_XC_TH1:
    params->omega = dvc_omega_TH1;
    break;
...
const xc_func_info_type dvc_xc_func_info_gga_xc_th_fl = {
  ...
  XC_FAMILY_GGA,
  {&dvc_xc_ref_Tozer1997_183, NULL, NULL, NULL, NULL},
  XC_FLAGS_3D | XC_FLAGS_I_HAVE_ALL,
  1e-32,
  0, NULL, NULL,
  dvc_gga_xc_th1_init, NULL, 
...
const xc_func_info_type dvc_xc_func_info_gga_xc_th1 = {
  ...
  "Tozer and Handy v. 1",
  XC_FAMILY_GGA,
  {&dvc_xc_ref_Tozer1998_2545, NULL, NULL, NULL, NULL},
  XC_FLAGS_3D | XC_FLAGS_I_HAVE_ALL,
  1e-32,
  0, NULL, NULL,
  dvc_gga_xc_th1_init, NULL, 
