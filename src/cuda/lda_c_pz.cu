...
DEVICE static lda_c_pz_params dvc_pz_original = {
  {-0.1423, -0.0843},  /* gamma */
  { 1.0529,  1.3981},  /* beta1 */
  { 0.3334,  0.2611},  /* beta2 */
  { 0.0311,  0.01555}, /*  a    */
...
DEVICE static lda_c_pz_params dvc_pz_modified = {
  {-0.1423, -0.0843},   
  { 1.0529,  1.3981}, 
  { 0.3334,  0.2611}, 
  { 0.0311,  0.01555},
...
DEVICE static lda_c_pz_params dvc_pz_ob = {
  {-0.103756, -0.065951},
  { 0.56371,   1.11846},
  { 0.27358,   0.18797},
  { 0.031091,  0.015545},
...
DEVICE static void 
dvc_lda_c_pz_init(xc_func_type *p)
{
  ...
  case XC_LDA_C_PZ:
    memcpy(params, &dvc_pz_original, sizeof(lda_c_pz_params));
    break;
  case XC_LDA_C_PZ_MOD:
    memcpy(params, &dvc_pz_modified, sizeof(lda_c_pz_params));
    break;
  case XC_LDA_C_OB_PZ:
    memcpy(params, &dvc_pz_ob, sizeof(lda_c_pz_params));
    break;
  default:
    #ifndef __CUDACC__
...
DEVICE const xc_func_info_type dvc_xc_func_info_lda_c_pz = {
  ...
  "Perdew & Zunger",
  XC_FAMILY_LDA,
  {&dvc_xc_ref_Perdew1981_5048, NULL, NULL, NULL, NULL},
  XC_FLAGS_3D | XC_FLAGS_I_HAVE_ALL,
  1e-24,
  0, NULL, NULL,
  dvc_lda_c_pz_init, NULL,
...
DEVICE const xc_func_info_type dvc_xc_func_info_lda_c_pz_mod = {
  ...
  XC_FAMILY_LDA,
  {&dvc_xc_ref_Perdew1981_5048_mod, NULL, NULL, NULL, NULL},
  XC_FLAGS_3D | XC_FLAGS_I_HAVE_ALL,
  1e-24,
  0, NULL, NULL,
  dvc_lda_c_pz_init, NULL,
...
DEVICE const xc_func_info_type dvc_xc_func_info_lda_c_ob_pz = {
  ...
  XC_FAMILY_LDA,
  {&dvc_xc_ref_Ortiz1994_1391, &dvc_xc_ref_Ortiz1994_1391_err, NULL, NULL, NULL},
  XC_FLAGS_3D | XC_FLAGS_I_HAVE_ALL,
  1e-24,
  0, NULL, NULL,
  dvc_lda_c_pz_init, NULL,
