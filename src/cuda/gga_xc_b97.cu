...
DEVICE
static const gga_xc_b97_params dvc_par_hcth_93 = {
...
DEVICE
static const gga_xc_b97_params dvc_par_hcth_120 = {
...
DEVICE
static const gga_xc_b97_params dvc_par_hcth_147 = {
...
DEVICE
static const gga_xc_b97_params dvc_par_hcth_407 = {
...
DEVICE
static const gga_xc_b97_params dvc_par_b97 = {
...
DEVICE
static const gga_xc_b97_params dvc_par_b97_1 = {
...
DEVICE
static const gga_xc_b97_params dvc_par_b97_2 = {
...
DEVICE
static const gga_xc_b97_params dvc_par_b97_d = {
...
DEVICE
static const gga_xc_b97_params dvc_par_b97_k = {
...
DEVICE
static const gga_xc_b97_params dvc_par_b97_3 = {
...
DEVICE
static const gga_xc_b97_params dvc_par_sb98_1a = {
...
DEVICE
static const gga_xc_b97_params dvc_par_sb98_1b = {
...
DEVICE
static const gga_xc_b97_params dvc_par_sb98_1c = {
...
DEVICE
static const gga_xc_b97_params dvc_par_sb98_2a = {
...
DEVICE
static const gga_xc_b97_params dvc_par_sb98_2b = {
...
DEVICE
static const gga_xc_b97_params dvc_par_sb98_2c = {
...
DEVICE
static const gga_xc_b97_params dvc_par_b97_gga1 = {
...
DEVICE
static const gga_xc_b97_params dvc_par_hcth_p14 = {
...
DEVICE
static const gga_xc_b97_params dvc_par_hcth_p76 = {
...
DEVICE
static const gga_xc_b97_params dvc_par_hcth_407p = {
...
DEVICE
static const gga_xc_b97_params dvc_par_b97_1p = {
...
/* based on HCTH/407 */
DEVICE
static const gga_xc_b97_params dvc_par_hle16 = {
...
DEVICE
static void 
dvc_gga_xc_b97_init(xc_func_type *p)
{
  ...
  case XC_GGA_XC_HCTH_93:
    memcpy(params, &dvc_par_hcth_93, sizeof(gga_xc_b97_params));
    break;
  case XC_GGA_XC_HCTH_120:
    memcpy(params, &dvc_par_hcth_120, sizeof(gga_xc_b97_params));
    break;
  case XC_GGA_XC_HCTH_147:
    memcpy(params, &dvc_par_hcth_147, sizeof(gga_xc_b97_params));
    break;
  case XC_GGA_XC_HCTH_407:
    memcpy(params, &dvc_par_hcth_407, sizeof(gga_xc_b97_params));
    break;
  case XC_HYB_GGA_XC_B97:
     p->cam_alpha = 0.1943;
    memcpy(params, &dvc_par_b97, sizeof(gga_xc_b97_params));
    break;
  case XC_HYB_GGA_XC_B97_1:
    p->cam_alpha = 0.21;
    memcpy(params, &dvc_par_b97_1, sizeof(gga_xc_b97_params));
    break;
  case XC_HYB_GGA_XC_B97_2:
    p->cam_alpha = 0.21;
    memcpy(params, &dvc_par_b97_2, sizeof(gga_xc_b97_params));
    break;
  case XC_GGA_XC_B97_D:
    memcpy(params, &dvc_par_b97_d, sizeof(gga_xc_b97_params));
    break;
  case XC_HYB_GGA_XC_B97_K:
    p->cam_alpha = 0.42;
    memcpy(params, &dvc_par_b97_k, sizeof(gga_xc_b97_params));
    break;
  case XC_HYB_GGA_XC_B97_3:
    p->cam_alpha = 2.692880E-01;
    memcpy(params, &dvc_par_b97_3, sizeof(gga_xc_b97_params));
    break;
  case XC_HYB_GGA_XC_SB98_1a:
    p->cam_alpha = 0.229015;
    memcpy(params, &dvc_par_sb98_1a, sizeof(gga_xc_b97_params));
    break;
  case XC_HYB_GGA_XC_SB98_1b:
    p->cam_alpha = 0.199352;
    memcpy(params, &dvc_par_sb98_1b, sizeof(gga_xc_b97_params));
    break;
  case XC_HYB_GGA_XC_SB98_1c:
    p->cam_alpha = 0.192416;
    memcpy(params, &dvc_par_sb98_1c, sizeof(gga_xc_b97_params));
    break;
  case XC_HYB_GGA_XC_SB98_2a:
    p->cam_alpha = 0.232055;
    memcpy(params, &dvc_par_sb98_2a, sizeof(gga_xc_b97_params));
    break;
  case XC_HYB_GGA_XC_SB98_2b:
    p->cam_alpha = 0.237978;
    memcpy(params, &dvc_par_sb98_2b, sizeof(gga_xc_b97_params));
    break;
  case XC_HYB_GGA_XC_SB98_2c:
    p->cam_alpha = 0.219847;
    memcpy(params, &dvc_par_sb98_2c, sizeof(gga_xc_b97_params));
    break;
  case XC_GGA_XC_B97_GGA1:
    memcpy(params, &dvc_par_b97_gga1, sizeof(gga_xc_b97_params));
    break;
  case XC_GGA_XC_HCTH_P14:
    memcpy(params, &dvc_par_hcth_p14, sizeof(gga_xc_b97_params));
    break;
  case XC_GGA_XC_HCTH_P76:
    memcpy(params, &dvc_par_hcth_p76, sizeof(gga_xc_b97_params));
    break;
  case XC_GGA_XC_HCTH_407P:
    memcpy(params, &dvc_par_hcth_407p, sizeof(gga_xc_b97_params));
    break;
  case XC_HYB_GGA_XC_B97_1p:
    p->cam_alpha =  0.15;
    memcpy(params, &dvc_par_b97_1p, sizeof(gga_xc_b97_params));
    break;
  case XC_GGA_XC_HLE16:
    memcpy(params, &dvc_par_hle16, sizeof(gga_xc_b97_params));
    break;
  default:
    #ifndef __CUDACC__
...
extern DEVICE
const xc_func_info_type dvc_xc_func_info_hyb_gga_xc_b97 = {
  XC_HYB_GGA_XC_B97,
  XC_EXCHANGE_CORRELATION,
  "Becke 97",
  XC_FAMILY_HYB_GGA,
  {&dvc_xc_ref_Becke1997_8554, NULL, NULL, NULL, NULL},
  XC_FLAGS_3D | XC_FLAGS_I_HAVE_ALL,
  1e-21,
  0, NULL, NULL,
  dvc_gga_xc_b97_init, NULL,
  NULL, dvc_work_gga, NULL
};

extern DEVICE
const xc_func_info_type dvc_xc_func_info_hyb_gga_xc_b97_1 = {
  XC_HYB_GGA_XC_B97_1,
  XC_EXCHANGE_CORRELATION,
  "Becke 97-1",
  XC_FAMILY_HYB_GGA,
...
extern DEVICE
const xc_func_info_type dvc_xc_func_info_hyb_gga_xc_b97_2 = {
  XC_HYB_GGA_XC_B97_2,
  XC_EXCHANGE_CORRELATION,
  "Becke 97-2",
  XC_FAMILY_HYB_GGA,
  {&dvc_xc_ref_Wilson2001_9233, NULL, NULL, NULL, NULL},
  XC_FLAGS_3D | XC_FLAGS_I_HAVE_ALL,
  1e-21,
  0, NULL, NULL,
  dvc_gga_xc_b97_init, NULL,
...
extern DEVICE
const xc_func_info_type dvc_xc_func_info_gga_xc_b97_d = {
  XC_GGA_XC_B97_D,
  XC_EXCHANGE_CORRELATION,
  "Becke 97-D",
  XC_FAMILY_GGA,
  {&dvc_xc_ref_Grimme2006_1787, NULL, NULL, NULL, NULL},
  XC_FLAGS_3D | XC_FLAGS_I_HAVE_ALL,
  1e-21,
  0, NULL, NULL,
  dvc_gga_xc_b97_init, NULL, 
...
extern DEVICE
const xc_func_info_type dvc_xc_func_info_hyb_gga_xc_b97_k = {
  XC_HYB_GGA_XC_B97_K,
  XC_EXCHANGE_CORRELATION,
...
extern DEVICE
const xc_func_info_type dvc_xc_func_info_hyb_gga_xc_b97_3 = {
  XC_HYB_GGA_XC_B97_3,
  XC_EXCHANGE_CORRELATION,
  "Becke 97-3",
  XC_FAMILY_HYB_GGA,
  {&dvc_xc_ref_Keal2005_121103, NULL, NULL, NULL, NULL},
  XC_FLAGS_3D | XC_FLAGS_I_HAVE_ALL,
  1e-21,
  0, NULL, NULL,
  dvc_gga_xc_b97_init, NULL, 
...
extern DEVICE
const xc_func_info_type dvc_xc_func_info_gga_xc_hcth_93 = {
  XC_GGA_XC_HCTH_93,
  XC_EXCHANGE_CORRELATION,
  "HCTH/93",
  XC_FAMILY_GGA,
...
extern DEVICE
const xc_func_info_type dvc_xc_func_info_gga_xc_hcth_120 = {
  XC_GGA_XC_HCTH_120,
  XC_EXCHANGE_CORRELATION,
  "HCTH/120",
  XC_FAMILY_GGA,
  {&dvc_xc_ref_Boese2000_1670, NULL, NULL, NULL, NULL},
  XC_FLAGS_3D | XC_FLAGS_I_HAVE_ALL,
  1e-21,
  0, NULL, NULL,
  dvc_gga_xc_b97_init, NULL,
...
extern DEVICE
const xc_func_info_type dvc_xc_func_info_gga_xc_hcth_147 = {
  XC_GGA_XC_HCTH_147,
  XC_EXCHANGE_CORRELATION,
  "HCTH/147",
  XC_FAMILY_GGA,
...
extern DEVICE
const xc_func_info_type dvc_xc_func_info_gga_xc_hcth_407 = {
  XC_GGA_XC_HCTH_407,
  XC_EXCHANGE_CORRELATION,
  "HCTH/407",
  XC_FAMILY_GGA,
  {&dvc_xc_ref_Boese2001_5497, NULL, NULL, NULL, NULL},
  XC_FLAGS_3D | XC_FLAGS_I_HAVE_ALL,
  1e-21,
  0, NULL, NULL,
  dvc_gga_xc_b97_init, NULL,
...
extern DEVICE
const xc_func_info_type dvc_xc_func_info_hyb_gga_xc_sb98_1a = {
  XC_HYB_GGA_XC_SB98_1a,
  XC_EXCHANGE_CORRELATION,
  "SB98 (1a)",
  XC_FAMILY_HYB_GGA,
  {&dvc_xc_ref_Schmider1998_9624, NULL, NULL, NULL, NULL},
  XC_FLAGS_3D | XC_FLAGS_I_HAVE_ALL,
  1e-21,
  0, NULL, NULL,
  dvc_gga_xc_b97_init, NULL,
...
extern DEVICE
const xc_func_info_type dvc_xc_func_info_hyb_gga_xc_sb98_1b = {
...
extern DEVICE
const xc_func_info_type dvc_xc_func_info_hyb_gga_xc_sb98_1c = {
...
extern DEVICE
const xc_func_info_type dvc_xc_func_info_hyb_gga_xc_sb98_2a = {
...
extern DEVICE
const xc_func_info_type dvc_xc_func_info_hyb_gga_xc_sb98_2b = {
...
extern DEVICE
const xc_func_info_type dvc_xc_func_info_hyb_gga_xc_sb98_2c = {
...
extern DEVICE
const xc_func_info_type dvc_xc_func_info_gga_xc_b97_gga1 = {
  XC_GGA_XC_B97_GGA1,
  XC_EXCHANGE_CORRELATION,
  "Becke 97 GGA-1",
  XC_FAMILY_GGA,
  {&dvc_xc_ref_Cohen2000_160, NULL, NULL, NULL, NULL},
  XC_FLAGS_3D | XC_FLAGS_I_HAVE_ALL,
  1e-21,
  0, NULL, NULL,
  dvc_gga_xc_b97_init, NULL, 
...
extern DEVICE
const xc_func_info_type dvc_xc_func_info_gga_xc_hcth_p14 = {
  XC_GGA_XC_HCTH_P14,
  XC_EXCHANGE_CORRELATION,
  "HCTH p=1/4",
  XC_FAMILY_GGA, 
  {&dvc_xc_ref_Menconi2001_3958, NULL, NULL, NULL, NULL},
  XC_FLAGS_3D | XC_FLAGS_I_HAVE_ALL,
  1e-21,
  0, NULL, NULL,
  dvc_gga_xc_b97_init, NULL,
...
extern DEVICE
const xc_func_info_type dvc_xc_func_info_gga_xc_hcth_p76 = {
  XC_GGA_XC_HCTH_P76,
  XC_EXCHANGE_CORRELATION,
  "HCTH p=7/6",
  XC_FAMILY_GGA,
...
extern DEVICE
const xc_func_info_type dvc_xc_func_info_gga_xc_hcth_407p = {
  XC_GGA_XC_HCTH_407P,
  XC_EXCHANGE_CORRELATION,
  "HCTH/407+",
  XC_FAMILY_GGA,
  {&dvc_xc_ref_Boese2003_5965, NULL, NULL, NULL, NULL},
  XC_FLAGS_3D | XC_FLAGS_I_HAVE_ALL,
  1e-21,
  0, NULL, NULL,
  dvc_gga_xc_b97_init, NULL,
...
extern DEVICE
const xc_func_info_type dvc_xc_func_info_hyb_gga_xc_b97_1p = {
...
extern DEVICE
const xc_func_info_type dvc_xc_func_info_gga_xc_hle16 = {
  XC_GGA_XC_HLE16,
  XC_EXCHANGE_CORRELATION,
  "high local exchange 2016",
  XC_FAMILY_GGA,
  {&dvc_xc_ref_Verma2017_380, NULL, NULL, NULL, NULL},
  XC_FLAGS_3D | XC_FLAGS_I_HAVE_ALL,
  1e-21,
  0, NULL, NULL,
  dvc_gga_xc_b97_init, NULL,
