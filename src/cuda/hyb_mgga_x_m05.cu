...
DEVICE static void
dvc_mgga_x_m05_init(xc_func_type *p)
{
  ...
  case XC_HYB_MGGA_X_M05: 
    memcpy(params, &dvc_par_m05, sizeof(mgga_x_m05_params));
    p->cam_alpha   = 0.28;
    break;
  case XC_HYB_MGGA_X_M05_2X:
    memcpy(params, &dvc_par_m05_2x, sizeof(mgga_x_m05_params));
    p->cam_alpha   = 0.56;
    break;
  case XC_HYB_MGGA_X_M06_2X:
    memcpy(params, &dvc_par_m06_2x, sizeof(mgga_x_m05_params));
    p->cam_alpha   = 0.54;
    break;
  default:
    #ifndef __CUDACC__
