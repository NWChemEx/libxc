...
DEVICE void
dvc_xc_hyb_gga_xc_lcy_blyp_init(xc_func_type *p)
{
...
extern DEVICE
const xc_func_info_type dvc_xc_func_info_hyb_gga_xc_lcy_blyp = {
  XC_HYB_GGA_XC_LCY_BLYP,
  XC_EXCHANGE_CORRELATION,
  "LCY version of BLYP",
  XC_FAMILY_HYB_GGA,
  {&dvc_xc_ref_Akinaga2008_348, &dvc_xc_ref_Seth2013_2286, NULL, NULL, NULL},
  XC_FLAGS_3D | XC_FLAGS_HYB_LCY | XC_FLAGS_HAVE_EXC | XC_FLAGS_I_HAVE_VXC,
  1e-32,
  0, NULL, NULL,
  dvc_xc_hyb_gga_xc_lcy_blyp_init, NULL,
  NULL, NULL, NULL
};
