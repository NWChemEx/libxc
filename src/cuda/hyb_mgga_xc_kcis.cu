...
DEVICE static void
dvc_hyb_mgga_xc_kcis_init(xc_func_type *p)
{
  /* Exchange functional */
  int xid;
...
const xc_func_info_type dvc_xc_func_info_hyb_mgga_xc_mpw1kcis = {
  ...
  XC_FAMILY_HYB_MGGA,
  {&dvc_xc_ref_Zhao2005_2012, NULL, NULL, NULL, NULL},
  XC_FLAGS_3D | XC_FLAGS_HAVE_EXC | XC_FLAGS_I_HAVE_VXC | XC_FLAGS_DEVELOPMENT,
  1e-32,
  0, NULL, NULL,
  dvc_hyb_mgga_xc_kcis_init,
...
const xc_func_info_type dvc_xc_func_info_hyb_mgga_xc_pbe1kcis = {
  ...
  XC_FAMILY_HYB_MGGA,
  {&dvc_xc_ref_Zhao2005_415, NULL, NULL, NULL, NULL},
  XC_FLAGS_3D | XC_FLAGS_HAVE_EXC | XC_FLAGS_I_HAVE_VXC | XC_FLAGS_DEVELOPMENT,
  1e-32,
  0, NULL, NULL,
  dvc_hyb_mgga_xc_kcis_init,
...
const xc_func_info_type dvc_xc_func_info_hyb_mgga_xc_tpss1kcis = {
  ...
  XC_FAMILY_HYB_MGGA,
  {&dvc_xc_ref_Zhao2005_43, NULL, NULL, NULL, NULL},
  XC_FLAGS_3D | XC_FLAGS_HAVE_EXC | XC_FLAGS_I_HAVE_VXC | XC_FLAGS_DEVELOPMENT,
  1e-32,
  0, NULL, NULL,
  dvc_hyb_mgga_xc_kcis_init,
