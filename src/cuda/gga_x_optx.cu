...
DEVICE
static void 
dvc_gga_x_optx_init(xc_func_type *p)
{
...
dvc_set_ext_params(xc_func_type *p, const double *ext_params)
{
  ...
  params->gamma = dvc_get_ext_param(p->info->ext_params, ext_params, 2);
}
...
DEVICE
const xc_func_info_type dvc_xc_func_info_gga_x_optx = {
  XC_GGA_X_OPTX,
  XC_EXCHANGE,
  "Handy & Cohen OPTX 01",
  XC_FAMILY_GGA,
  {&dvc_xc_ref_Handy2001_403, NULL, NULL, NULL, NULL},
  XC_FLAGS_3D | XC_FLAGS_I_HAVE_ALL,
  1e-22,
  3, dvc_ext_params, dvc_set_ext_params,
  dvc_gga_x_optx_init, NULL, 
