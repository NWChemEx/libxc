...
DEVICE
static const gga_c_sogga11_params dvc_par_sogga11 = {
  {0.50000, -4.62334,  8.00410, -130.226,  38.2685,   69.5599},
  {0.50000,   3.62334, 9.36393, 34.5114, -18.5684,   -0.16519}
};

DEVICE
static const gga_c_sogga11_params dvc_par_sogga11_x = {
...
DEVICE
static void 
dvc_gga_c_sogga11_init(xc_func_type *p)
{
  ...
  case XC_GGA_C_SOGGA11:
    memcpy(params, &dvc_par_sogga11, sizeof(gga_c_sogga11_params));
    break;
  case XC_GGA_C_SOGGA11_X:
    memcpy(params, &dvc_par_sogga11_x, sizeof(gga_c_sogga11_params));
    break;
  default:
    #ifndef __CUDACC__
