...
DEVICE static const double dvc_a_m06l[12] = {
  0.3987756, 0.2548219, 0.3923994, -2.103655, -6.302147, 10.97615,
  30.97273,  -23.18489, -56.73480, 21.60364, 34.21814, -9.049762
};
DEVICE static const double dvc_d_m06l[6] = {0.6012244, 0.004748822, -0.008635108, -0.000009308062, 0.00004482811, 0.0};

DEVICE static const double dvc_a_m06hf[12] = {
...
DEVICE static const double dvc_d_m06hf[6] = {-1.179732e-01, -2.500000e-03, -1.180065e-02, 0.0, 0.0, 0.0};

DEVICE static const double dvc_a_m06[12] = {
...
DEVICE static const double dvc_d_m06[6] = {1.422057e-01, 7.370319e-04, -1.601373e-02, 0.0, 0.0, 0.0};

DEVICE static const double dvc_a_revm06l[12] = {
...
DEVICE static const double dvc_d_revm06l[6] = {-0.423227252, 0.0, 0.003724234, 0.0, 0.0, 0.0};
...
DEVICE static void
dvc_mgga_x_m06l_init(xc_func_type *p)
{
  ...
  case XC_HYB_MGGA_X_M06_HF:
    params->a = dvc_a_m06hf;
    params->d = dvc_d_m06hf;
    p->cam_alpha = 1.0;
    break;
  ...
  case XC_MGGA_X_REVM06_L:
    params->a = dvc_a_revm06l;
    params->d = dvc_d_revm06l;
    break;
  default:
    #ifndef __CUDACC__
