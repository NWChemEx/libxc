...
DEVICE static const mgga_x_m11_params dvc_par_m11 = {
  {
...
DEVICE static const mgga_x_m11_params dvc_par_revm11 = {
  {
...
DEVICE static void
dvc_mgga_x_m11_init(xc_func_type *p)
{
  ...
  case XC_HYB_MGGA_X_M11:
    memcpy(params, &dvc_par_m11, sizeof(mgga_x_m11_params));
    p->cam_alpha = 1.0;
    p->cam_beta  = -(1.0 - 0.428);
    p->cam_omega = 0.25;
    break;
  case XC_HYB_MGGA_X_REVM11:
    memcpy(params, &dvc_par_revm11, sizeof(mgga_x_m11_params));
    p->cam_alpha = 1.0;
...
extern DEVICE const xc_func_info_type dvc_xc_func_info_hyb_mgga_x_m11 = {
  XC_HYB_MGGA_X_M11,
  XC_EXCHANGE,
  ...
  1e-11,
  0, NULL, NULL,
  dvc_mgga_x_m11_init, NULL,
  NULL, NULL, dvc_work_mgga,
};

extern DEVICE const xc_func_info_type dvc_xc_func_info_hyb_mgga_x_revm11 = {
