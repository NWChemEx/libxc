...
/*************************************************************/
DEVICE void
dvc_xc_hyb_mgga_xc_b88b95_init(xc_func_type *p)
{
...
const xc_func_info_type dvc_xc_func_info_hyb_mgga_xc_b88b95 = {
  ...
  1e-32,
  0, NULL, NULL,
  dvc_xc_hyb_mgga_xc_b88b95_init,
  NULL, NULL, NULL, NULL,
};
...
/*************************************************************/
DEVICE void
dvc_xc_hyb_mgga_xc_b86b95_init(xc_func_type *p)
{
...
const xc_func_info_type dvc_xc_func_info_hyb_mgga_xc_b86b95 = {
  ...
  1e-32,
  0, NULL, NULL,
  dvc_xc_hyb_mgga_xc_b86b95_init,
  NULL, NULL, NULL, NULL,
};
...
/*************************************************************/
DEVICE void
dvc_xc_hyb_mgga_xc_pw86b95_init(xc_func_type *p)
{
...
const xc_func_info_type dvc_xc_func_info_hyb_mgga_xc_pw86b95 = {
  ...
  1e-32,
  0, NULL, NULL,
  dvc_xc_hyb_mgga_xc_pw86b95_init,
  NULL, NULL, NULL, NULL,
};
...
/*************************************************************/
DEVICE void
dvc_xc_hyb_mgga_xc_bb1k_init(xc_func_type *p)
{
  static int   funcs_id  [2] = {XC_GGA_X_B88, XC_MGGA_C_BC95};
...
const xc_func_info_type dvc_xc_func_info_hyb_mgga_xc_bb1k = {
  ...
  XC_FAMILY_HYB_MGGA,
  {&dvc_xc_ref_Zhao2004_2715, NULL, NULL, NULL, NULL},
  XC_FLAGS_3D | XC_FLAGS_HAVE_EXC | XC_FLAGS_I_HAVE_VXC,
  1e-32,
  0, NULL, NULL,
  dvc_xc_hyb_mgga_xc_bb1k_init,
  NULL, NULL, NULL, NULL,
};
...
/*************************************************************/
DEVICE void
dvc_xc_hyb_mgga_xc_mpw1b95_init(xc_func_type *p)
{
...
const xc_func_info_type dvc_xc_func_info_hyb_mgga_xc_mpw1b95 = {
  ...
  1e-32,
  0, NULL, NULL,
  dvc_xc_hyb_mgga_xc_mpw1b95_init,
  NULL, NULL, NULL, NULL,
};
...
/*************************************************************/
DEVICE void
dvc_xc_hyb_mgga_xc_mpwb1k_init(xc_func_type *p)
{
  static int   funcs_id  [2] = {XC_GGA_X_MPW91, XC_MGGA_C_BC95};
...
const xc_func_info_type dvc_xc_func_info_hyb_mgga_xc_mpwb1k = {
  ...
  1e-32,
  0, NULL, NULL,
  dvc_xc_hyb_mgga_xc_mpwb1k_init,
  NULL, NULL, NULL, NULL,
};
...
/*************************************************************/
DEVICE void
dvc_xc_hyb_mgga_xc_x1b95_init(xc_func_type *p)
{
...
/*************************************************************/
DEVICE void
dvc_xc_hyb_mgga_xc_xb1k_init(xc_func_type *p)
{
...
/*************************************************************/
DEVICE void
dvc_xc_hyb_mgga_xc_pw6b95_init(xc_func_type *p)
{
  static int    funcs_id  [2] = {XC_GGA_X_MPW91, XC_MGGA_C_BC95};
  static double funcs_coef[2] = {1.0 - 0.28, 1.0};
  ...
  dvc_xc_func_set_ext_params(p->func_aux[1], par_c_bc95);
  p->cam_alpha = 0.28;
}
...
const xc_func_info_type dvc_xc_func_info_hyb_mgga_xc_pw6b95 = {
  ...
  XC_FAMILY_HYB_MGGA,
  {&dvc_xc_ref_Zhao2005_5656, NULL, NULL, NULL, NULL},
  XC_FLAGS_3D | XC_FLAGS_HAVE_EXC | XC_FLAGS_I_HAVE_VXC,
  1e-32,
  0, NULL, NULL,
  dvc_xc_hyb_mgga_xc_pw6b95_init,
  NULL, NULL, NULL, NULL,
};
...
/*************************************************************/
DEVICE void
dvc_xc_hyb_mgga_xc_pwb6k_init(xc_func_type *p)
{
  static int    funcs_id  [2] = {XC_GGA_X_MPW91, XC_MGGA_C_BC95};
...
/*************************************************************/
DEVICE static void
dvc_mgga_xc_tpsslyp1w_init(xc_func_type *p)
{
