...
DEVICE
static const double dvc_CC_N12[4][4] = {
...
DEVICE
static const double dvc_CC_N12_SX[4][4] = {
...
DEVICE
static const double dvc_CC_GAM[4][4] = {
...
DEVICE
static void
dvc_gga_x_n12_init(xc_func_type *p)
{
  ...
  case XC_GGA_X_N12: 
    params->CC = dvc_CC_N12;
    break;
  case XC_HYB_GGA_X_N12_SX:
    params->CC = dvc_CC_N12_SX;
    p->cam_alpha = 0.00;
    p->cam_beta  = 0.25;
    p->cam_omega = 0.11;
    break;
  case XC_GGA_X_GAM:
    params->CC = dvc_CC_GAM;
    break;
  default:
    #ifndef __CUDACC__
