...
DEVICE
static const gga_xc_wb97_params dvc_par_wb97 = {
...
DEVICE
static const gga_xc_wb97_params dvc_par_wb97x = {
...
DEVICE
static const gga_xc_wb97_params dvc_par_wb97x_v = {
...
DEVICE
static const gga_xc_wb97_params dvc_par_wb97x_d = {
...
DEVICE static void 
dvc_gga_xc_wb97_init(xc_func_type *p)
{
  ...
  case XC_HYB_GGA_XC_WB97:
    ...
    p->cam_omega =  0.4;
    p->cam_beta  = -1.0;
    memcpy(params, &dvc_par_wb97, sizeof(gga_xc_wb97_params));
    break;
  case XC_HYB_GGA_XC_WB97X:
    p->cam_alpha =  1.0;
    p->cam_omega =  0.3;
    p->cam_beta  = -(1.0 - 1.57706e-01);
    memcpy(params, &dvc_par_wb97x, sizeof(gga_xc_wb97_params));
    break;
  case XC_HYB_GGA_XC_WB97X_V:
    ...
    p->nlc_b = 6.0;
    p->nlc_C = 0.01;
    memcpy(params, &dvc_par_wb97x_v, sizeof(gga_xc_wb97_params));
    break;
  case XC_HYB_GGA_XC_WB97X_D:
    p->cam_alpha =  1.0;
    p->cam_omega =  0.2;
    p->cam_beta  = -(1.0 - 2.22036e-01);
    memcpy(params, &dvc_par_wb97x_d, sizeof(gga_xc_wb97_params));
    break;
  default:
    #ifndef __CUDACC__
...
DEVICE
const xc_func_info_type dvc_xc_func_info_hyb_gga_xc_wb97 = {
  XC_HYB_GGA_XC_WB97,
  XC_EXCHANGE_CORRELATION,
  "wB97 range-separated functional",
  XC_FAMILY_HYB_GGA,
  {&dvc_xc_ref_Chai2008_084106, NULL, NULL, NULL, NULL},
  XC_FLAGS_3D | XC_FLAGS_HYB_CAM | XC_FLAGS_I_HAVE_ALL,
  1e-23,
  0, NULL, NULL,
  dvc_gga_xc_wb97_init, NULL,
  NULL, dvc_work_gga, NULL
};

DEVICE
const xc_func_info_type dvc_xc_func_info_hyb_gga_xc_wb97x = {
  XC_HYB_GGA_XC_WB97X,
  XC_EXCHANGE_CORRELATION,
...
DEVICE
const xc_func_info_type dvc_xc_func_info_hyb_gga_xc_wb97x_v = {
  XC_HYB_GGA_XC_WB97X_V,
  XC_EXCHANGE_CORRELATION,
  "wB97X-V range-separated functional",
  XC_FAMILY_HYB_GGA,
  {&dvc_xc_ref_Mardirossian2014_9904, NULL, NULL, NULL, NULL},
...
DEVICE
const xc_func_info_type dvc_xc_func_info_hyb_gga_xc_wb97x_d = {
  XC_HYB_GGA_XC_WB97X_D,
  XC_EXCHANGE_CORRELATION,
  "wB97D range-separated functional",
  XC_FAMILY_HYB_GGA,
  {&dvc_xc_ref_Chai2008_6615, NULL, NULL, NULL, NULL},
  XC_FLAGS_3D | XC_FLAGS_HYB_CAM | XC_FLAGS_I_HAVE_ALL,
  1e-23,
  0, NULL, NULL,
  dvc_gga_xc_wb97_init, NULL,
