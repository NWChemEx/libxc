...
DEVICE static const mgga_c_vsxc_params dvc_par_vsxc = {
...
dvc_mgga_c_vsxc_init(xc_func_type *p)
{
  ...
  case XC_MGGA_C_VSXC:
    memcpy(params, &dvc_par_vsxc, sizeof(mgga_c_vsxc_params));
    break;
  default:
    #ifndef __CUDACC__
...
extern DEVICE const xc_func_info_type dvc_xc_func_info_mgga_c_vsxc = {
  XC_MGGA_C_VSXC,
  XC_CORRELATION,
