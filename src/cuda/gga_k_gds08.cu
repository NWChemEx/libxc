...
DEVICE
static void
dvc_gga_k_gds08_init(xc_func_type *p)
{
...
const xc_func_info_type dvc_xc_func_info_gga_k_gds08 = {
  ...
  1e-24,
  0, NULL, NULL,
  dvc_gga_k_gds08_init, NULL,
  NULL, NULL, NULL
};

DEVICE
static void
dvc_gga_k_ghds10_init(xc_func_type *p)
{
...
const xc_func_info_type dvc_xc_func_info_gga_k_ghds10 = {
  ...
  XC_FAMILY_GGA,
  {&dvc_xc_ref_Ghiringhelli2010_014106, NULL, NULL, NULL, NULL},
  XC_FLAGS_3D | XC_FLAGS_I_HAVE_ALL,
  1e-24,
  0, NULL, NULL,
  dvc_gga_k_ghds10_init, NULL,
  NULL, NULL, NULL
};

DEVICE
static void
dvc_gga_k_ghds10r_init(xc_func_type *p)
{
  static int    funcs_id  [2] = {XC_GGA_K_TFVW, XC_LDA_K_GDS08_WORKER};
  static double funcs_coef[2] = {1.0, 1.0};
...
const xc_func_info_type dvc_xc_func_info_gga_k_ghds10r = {
  ...
  XC_FAMILY_GGA,
  {&dvc_xc_ref_Trickey2011_075146, &dvc_xc_ref_Ghiringhelli2010_014106, NULL, NULL, NULL},
  XC_FLAGS_3D | XC_FLAGS_I_HAVE_ALL,
  1e-24,
  0, NULL, NULL,
  dvc_gga_k_ghds10r_init, NULL,
  NULL, NULL, NULL
};

DEVICE
static void
dvc_gga_k_tkvln_init(xc_func_type *p)
{
  static int    funcs_id  [2] = {XC_GGA_K_TFVW, XC_LDA_K_GDS08_WORKER};
  static double funcs_coef[2] = {1.0, 1.0};
