...
DEVICE static const mgga_c_m06l_params dvc_par_m06l = {
...
DEVICE static const mgga_c_m06l_params dvc_par_m06hf = {
  0.06, 0.0031, 0.00515088, 0.00304966,
...
DEVICE static const mgga_c_m06l_params dvc_par_m06 = {
  0.06, 0.0031, 0.00515088, 0.00304966,  
...
DEVICE static const mgga_c_m06l_params dvc_par_m062x = {
  0.06, 0.0031, 0.00515088, 0.00304966,  
...
DEVICE static const mgga_c_m06l_params dvc_par_revm06l = {
  0.06, 0.0031, 0.00515088, 0.00304966,
...
DEVICE static void 
dvc_mgga_c_m06l_init(xc_func_type *p)
{
  ...
  dvc_xc_func_init(p->func_aux[0], XC_LDA_C_PW_MOD, XC_POLARIZED);
  ...
  case XC_MGGA_C_M06_L:
    memcpy(params, &dvc_par_m06l, sizeof(mgga_c_m06l_params));
    break;
  case XC_MGGA_C_M06_HF: 
    memcpy(params, &dvc_par_m06hf, sizeof(mgga_c_m06l_params));
    break;
  case XC_MGGA_C_M06:
    memcpy(params, &dvc_par_m06, sizeof(mgga_c_m06l_params));
    break;
  case XC_MGGA_C_M06_2X:
    memcpy(params, &dvc_par_m062x, sizeof(mgga_c_m06l_params));
    break;
  case XC_MGGA_C_REVM06_L:
    memcpy(params, &dvc_par_revm06l, sizeof(mgga_c_m06l_params));
    break;
  default:
    #ifndef __CUDACC__
...
extern DEVICE const xc_func_info_type dvc_xc_func_info_mgga_c_m06_l = {
  XC_MGGA_C_M06_L,
  XC_CORRELATION,
  "Minnesota M06-L correlation functional",
  XC_FAMILY_MGGA,
  {&dvc_xc_ref_Zhao2006_194101, &dvc_xc_ref_Zhao2008_215, NULL, NULL, NULL},
  XC_FLAGS_3D | XC_FLAGS_I_HAVE_ALL,
  1.0e-23,
  1, dvc_ext_params, dvc_set_ext_params,
  dvc_mgga_c_m06l_init, NULL,
  NULL, NULL, dvc_work_mgga,
};

extern DEVICE const xc_func_info_type dvc_xc_func_info_mgga_c_m06_hf = {
  XC_MGGA_C_M06_HF,
  XC_CORRELATION,
  "Minnesota M06-HF correlation functional",
  XC_FAMILY_MGGA,
  {&dvc_xc_ref_Zhao2006_13126, NULL, NULL, NULL, NULL},
  XC_FLAGS_3D | XC_FLAGS_I_HAVE_ALL,
  1.0e-23,
  1, dvc_ext_params, dvc_set_ext_params,
  dvc_mgga_c_m06l_init, NULL, 
...
extern DEVICE const xc_func_info_type dvc_xc_func_info_mgga_c_m06 = {
  XC_MGGA_C_M06,
  XC_CORRELATION,
  "Minnesota M06 correlation functional",
  XC_FAMILY_MGGA,
  {&dvc_xc_ref_Zhao2008_215, NULL, NULL, NULL, NULL},
  XC_FLAGS_3D | XC_FLAGS_I_HAVE_ALL,
  1.0e-23,
  1, dvc_ext_params, dvc_set_ext_params,
  dvc_mgga_c_m06l_init, NULL,
...
extern DEVICE const xc_func_info_type dvc_xc_func_info_mgga_c_m06_2x = {
  XC_MGGA_C_M06_2X,
  XC_CORRELATION,
...
extern DEVICE const xc_func_info_type dvc_xc_func_info_mgga_c_revm06_l = {
  XC_MGGA_C_REVM06_L,
  XC_CORRELATION,
  "Minnesota revM06-L correlation functional",
  XC_FAMILY_MGGA,
  {&dvc_xc_ref_Wang2017_8487, NULL, NULL, NULL, NULL},
  XC_FLAGS_3D | XC_FLAGS_I_HAVE_ALL,
  5.0e-13,
  1, dvc_ext_params, dvc_set_ext_params,
  dvc_mgga_c_m06l_init, NULL,
