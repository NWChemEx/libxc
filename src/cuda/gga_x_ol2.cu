...
DEVICE
static void 
dvc_gga_x_ol2_init(xc_func_type *p)
{
...
DEVICE
const xc_func_info_type dvc_xc_func_info_gga_x_ol2 = {
  XC_GGA_X_OL2,
  XC_EXCHANGE,
  "Exchange form based on Ou-Yang and Levy v.2",
  XC_FAMILY_GGA,
  {&dvc_xc_ref_Fuentealba1995_31, &dvc_xc_ref_OuYang1991_379, NULL, NULL, NULL},
  XC_FLAGS_3D | XC_FLAGS_I_HAVE_ALL,
  5e-26,
  0, NULL, NULL,
  dvc_gga_x_ol2_init, NULL, 
