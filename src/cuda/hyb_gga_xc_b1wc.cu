...
DEVICE void
dvc_xc_hyb_gga_xc_b1wc_init(xc_func_type *p)
{
...
const xc_func_info_type dvc_xc_func_info_hyb_gga_xc_b1wc = {
  ...
  "B1WC",
  XC_FAMILY_HYB_GGA,
  {&dvc_xc_ref_Bilc2008_165107, NULL, NULL, NULL, NULL},
  XC_FLAGS_3D | XC_FLAGS_I_HAVE_ALL,
  1e-32,
  0, NULL, NULL,
  dvc_xc_hyb_gga_xc_b1wc_init,
  NULL, NULL, NULL, NULL
};


DEVICE void
dvc_xc_hyb_gga_xc_b1lyp_init(xc_func_type *p)
{
...
const xc_func_info_type dvc_xc_func_info_hyb_gga_xc_b1lyp = {
  ...
  "B1LYP",
  XC_FAMILY_HYB_GGA,
  {&dvc_xc_ref_Adamo1997_242, NULL, NULL, NULL, NULL},
  XC_FLAGS_3D | XC_FLAGS_I_HAVE_ALL,
  1e-32,
  0, NULL, NULL,
  dvc_xc_hyb_gga_xc_b1lyp_init,
  NULL, NULL, NULL, NULL
};


DEVICE void
dvc_xc_hyb_gga_xc_b1pw91_init(xc_func_type *p)
{
...
const xc_func_info_type dvc_xc_func_info_hyb_gga_xc_b1pw91 = {
  ...
  1e-32,
  0, NULL, NULL,
  dvc_xc_hyb_gga_xc_b1pw91_init,
  NULL, NULL, NULL, NULL
};


DEVICE void
dvc_xc_hyb_gga_xc_mpw1pw_init(xc_func_type *p)
{
...
DEVICE
void
dvc_xc_hyb_gga_xc_mpw1k_init(xc_func_type *p)
{
...
const xc_func_info_type dvc_xc_func_info_hyb_gga_xc_mpw1k = {
  ...
  "mPW1K",
  XC_FAMILY_HYB_GGA,
  {&dvc_xc_ref_Lynch2000_4811, NULL, NULL, NULL, NULL},
  XC_FLAGS_3D | XC_FLAGS_I_HAVE_ALL,
  1e-32,
  0, NULL, NULL,
  dvc_xc_hyb_gga_xc_mpw1k_init,
  NULL, NULL, NULL, NULL
};
...
DEVICE
void
dvc_xc_hyb_gga_xc_bhandh_init(xc_func_type *p)
{
...
const xc_func_info_type dvc_xc_func_info_hyb_gga_xc_bhandh = {
  ...
  "BHandH",
  XC_FAMILY_HYB_GGA,
  {&dvc_xc_ref_Becke1993_1372, &dvc_xc_ref_gaussianimplementation, NULL, NULL, NULL},
  XC_FLAGS_3D | XC_FLAGS_I_HAVE_ALL,
  1e-32,
  0, NULL, NULL,
  dvc_xc_hyb_gga_xc_bhandh_init,
  NULL, NULL, NULL, NULL
};
...
DEVICE
void
dvc_xc_hyb_gga_xc_bhandhlyp_init(xc_func_type *p)
{
  static int   funcs_id  [2] = {XC_GGA_X_B88, XC_GGA_C_LYP};
  static double funcs_coef[2] = {0.5, 1.0};
...
const xc_func_info_type dvc_xc_func_info_hyb_gga_xc_bhandhlyp = {
  ...
  1e-32,
  0, NULL, NULL,
  dvc_xc_hyb_gga_xc_bhandhlyp_init,
  NULL, NULL, NULL, NULL
};
...
DEVICE
void
dvc_xc_hyb_gga_xc_mpwlyp1m_init(xc_func_type *p)
{
...
const xc_func_info_type dvc_xc_func_info_hyb_gga_xc_mpwlyp1m = {
  ...
  XC_FAMILY_HYB_GGA,
  {&dvc_xc_ref_Schultz2005_11127, NULL, NULL, NULL, NULL},
  XC_FLAGS_3D | XC_FLAGS_I_HAVE_ALL,
  1e-32,
  0, NULL, NULL,
  dvc_xc_hyb_gga_xc_mpwlyp1m_init,
  NULL, NULL, NULL, NULL
};
