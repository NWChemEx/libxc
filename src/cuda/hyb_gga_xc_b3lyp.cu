...
/*************************************************************/
DEVICE void
dvc_xc_hyb_gga_xc_b3pw91_init(xc_func_type *p)
{
...
extern DEVICE 
const xc_func_info_type dvc_xc_func_info_hyb_gga_xc_b3pw91 = {
  XC_HYB_GGA_XC_B3PW91,
  XC_EXCHANGE_CORRELATION,
  "The original (ACM, B3PW91) hybrid of Becke",
  XC_FAMILY_HYB_GGA,
  {&dvc_xc_ref_Becke1993_5648, NULL, NULL, NULL, NULL},
  XC_FLAGS_3D | XC_FLAGS_I_HAVE_ALL,
  1e-32,
  0, NULL, NULL,
  dvc_xc_hyb_gga_xc_b3pw91_init,
  NULL, NULL, NULL, NULL
};
...
/*************************************************************/
DEVICE void
dvc_xc_hyb_gga_xc_b3lyp_init(xc_func_type *p)
{
...
extern DEVICE
const xc_func_info_type dvc_xc_func_info_hyb_gga_xc_b3lyp = {
  XC_HYB_GGA_XC_B3LYP,
  XC_EXCHANGE_CORRELATION,
  "B3LYP",
  XC_FAMILY_HYB_GGA,
  {&dvc_xc_ref_Stephens1994_11623, NULL, NULL, NULL, NULL},
  XC_FLAGS_3D | XC_FLAGS_I_HAVE_ALL,
  1e-32,
  0, NULL, NULL,
  dvc_xc_hyb_gga_xc_b3lyp_init,
  NULL, NULL, NULL, NULL
};

/*************************************************************/
DEVICE void
dvc_xc_hyb_gga_xc_b3lyp5_init(xc_func_type *p)
{
...
extern DEVICE
const xc_func_info_type dvc_xc_func_info_hyb_gga_xc_b3lyp5 = {
...
/*************************************************************/
DEVICE void
dvc_xc_hyb_gga_xc_b3p86_init(xc_func_type *p)
{
...
extern DEVICE
const xc_func_info_type dvc_xc_func_info_hyb_gga_xc_b3p86 = {
  XC_HYB_GGA_XC_B3P86,
  XC_EXCHANGE_CORRELATION,
  "B3P86",
  XC_FAMILY_HYB_GGA,
  {&dvc_xc_ref_gaussianimplementation, NULL, NULL, NULL, NULL},
  XC_FLAGS_3D | XC_FLAGS_I_HAVE_ALL,
  1e-32,
  0, NULL, NULL,
  dvc_xc_hyb_gga_xc_b3p86_init,
  NULL, NULL, NULL, NULL
};
...
/*************************************************************/
DEVICE void
dvc_xc_hyb_gga_xc_mpw3pw_init(xc_func_type *p)
{
...
extern DEVICE
const xc_func_info_type dvc_xc_func_info_hyb_gga_xc_mpw3pw = {
...
/*************************************************************/
DEVICE void
dvc_xc_hyb_gga_xc_mpw3lyp_init(xc_func_type *p)
{
...
extern DEVICE
const xc_func_info_type dvc_xc_func_info_hyb_gga_xc_mpw3lyp = {
  XC_HYB_GGA_XC_MPW3LYP,
  XC_EXCHANGE_CORRELATION,
  "MPW3LYP",
  XC_FAMILY_HYB_GGA,
  {&dvc_xc_ref_Zhao2004_6908, NULL, NULL, NULL, NULL},
  XC_FLAGS_3D | XC_FLAGS_I_HAVE_ALL,
  1e-32,
  0, NULL, NULL,
  dvc_xc_hyb_gga_xc_mpw3lyp_init,
  NULL, NULL, NULL, NULL
};
...
/*************************************************************/
DEVICE void
dvc_xc_hyb_gga_xc_mb3lyp_rc04_init(xc_func_type *p)
{
...
extern DEVICE
const xc_func_info_type dvc_xc_func_info_hyb_gga_xc_mb3lyp_rc04 = {
  XC_HYB_GGA_XC_MB3LYP_RC04,
  XC_EXCHANGE_CORRELATION,
  "B3LYP with RC04 LDA",
  XC_FAMILY_HYB_GGA,
  {&dvc_xc_ref_Tognetti2007_381, NULL, NULL, NULL, NULL},
  XC_FLAGS_3D | XC_FLAGS_I_HAVE_ALL,
  1e-32,
  0, NULL, NULL,
  dvc_xc_hyb_gga_xc_mb3lyp_rc04_init,
  NULL, NULL, NULL, NULL
};

/*************************************************************/
DEVICE void
dvc_xc_hyb_gga_xc_revb3lyp_init(xc_func_type *p)
{
  static int   funcs_id  [4] = {XC_LDA_X, XC_GGA_X_B88, XC_LDA_C_VWN_RPA, XC_GGA_C_LYP};
...
extern DEVICE
const xc_func_info_type dvc_xc_func_info_hyb_gga_xc_revb3lyp = {
  XC_HYB_GGA_XC_REVB3LYP,
  XC_EXCHANGE_CORRELATION,
  "Revised B3LYP",
  XC_FAMILY_HYB_GGA,
  {&dvc_xc_ref_Lu2013_64, NULL, NULL, NULL, NULL},
  XC_FLAGS_3D | XC_FLAGS_I_HAVE_ALL,
  1e-32,
  0, NULL, NULL,
  dvc_xc_hyb_gga_xc_revb3lyp_init,
  NULL, NULL, NULL, NULL
};
...
/*************************************************************/
DEVICE void
dvc_xc_hyb_gga_xc_b3lyps_init(xc_func_type *p)
{
  static int   funcs_id  [4] = {XC_LDA_X, XC_GGA_X_B88, XC_LDA_C_VWN_RPA, XC_GGA_C_LYP};
...
extern DEVICE
const xc_func_info_type dvc_xc_func_info_hyb_gga_xc_b3lyps = {
  XC_HYB_GGA_XC_B3LYPs,
  XC_EXCHANGE_CORRELATION,
  "B3LYP*",
  XC_FAMILY_HYB_GGA,
  {&dvc_xc_ref_Reiher2001_48, NULL, NULL, NULL, NULL},
  XC_FLAGS_3D | XC_FLAGS_I_HAVE_ALL,
  1e-32,
  0, NULL, NULL,
  dvc_xc_hyb_gga_xc_b3lyps_init,
  NULL, NULL, NULL, NULL
};
...
/*************************************************************/
DEVICE void
dvc_xc_hyb_gga_xc_b5050lyp_init(xc_func_type *p)
{
  static int   funcs_id  [4] = {XC_LDA_X, XC_GGA_X_B88, XC_LDA_C_VWN, XC_GGA_C_LYP};
...
extern DEVICE
const xc_func_info_type dvc_xc_func_info_hyb_gga_xc_b5050lyp = {
  XC_HYB_GGA_XC_B5050LYP,
  XC_EXCHANGE_CORRELATION,
  "B5050LYP",
  XC_FAMILY_HYB_GGA,
  {&dvc_xc_ref_Shao2003_4807, NULL, NULL, NULL, NULL},
  XC_FLAGS_3D | XC_FLAGS_I_HAVE_ALL,
  1e-32,
  0, NULL, NULL,
  dvc_xc_hyb_gga_xc_b5050lyp_init,
  NULL, NULL, NULL, NULL
};
...
/*************************************************************/
DEVICE void
dvc_xc_hyb_gga_xc_kmlyp_init(xc_func_type *p)
{
...
extern DEVICE
const xc_func_info_type dvc_xc_func_info_hyb_gga_xc_kmlyp = {
  XC_HYB_GGA_XC_KMLYP,
  XC_EXCHANGE_CORRELATION,
  "Kang-Musgrave hybrid",
  XC_FAMILY_HYB_GGA,
  {&dvc_xc_ref_Kang2001_11040, NULL, NULL, NULL, NULL},
  XC_FLAGS_3D | XC_FLAGS_I_HAVE_ALL,
  1e-32,
  0, NULL, NULL,
  dvc_xc_hyb_gga_xc_kmlyp_init,
  NULL, NULL, NULL, NULL
};
...
/*************************************************************/
DEVICE void
dvc_xc_hyb_gga_xc_apf_init(xc_func_type *p)
{
...
extern DEVICE
const xc_func_info_type dvc_xc_func_info_hyb_gga_xc_apf = {
  XC_HYB_GGA_XC_APF,
  XC_EXCHANGE_CORRELATION,
  "APF hybrid functional",
  XC_FAMILY_HYB_GGA,
  {&dvc_xc_ref_Austin2012_4989, NULL, NULL, NULL, NULL},
  XC_FLAGS_3D | XC_FLAGS_I_HAVE_ALL,
  1e-32,
  0, NULL, NULL,
  dvc_xc_hyb_gga_xc_apf_init,
  NULL, NULL, NULL, NULL
};
