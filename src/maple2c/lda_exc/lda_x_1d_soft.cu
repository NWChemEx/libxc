...
func_unpol(const xc_func_type *p, int order, const double *rho, double *zk, double *vrho, double *v2rho2, double *v3rho3)
{
  ...
  t3 = dvc_xc_integrate(func1, NULL, 0.0, t2);
  t4 = dvc_xc_integrate(func2, NULL, 0.0, t2);
  t5 = 0.1e1 / M_PI;
...
func_ferr(const xc_func_type *p, int order, const double *rho, double *zk, double *vrho, double *v2rho2, double *v3rho3)
{
  ...
  t4 = dvc_xc_integrate(func1, NULL, 0.0, t3);
  t6 = dvc_xc_integrate(func2, NULL, 0.0, t3);
  t7 = 0.1e1 / M_PI;
...
func_pol(const xc_func_type *p, int order, const double *rho, double *zk, double *vrho, double *v2rho2, double *v3rho3)
{
  ...
  t7 = params->beta * t2;
  t8 = t6 * t7;
  t9 = dvc_xc_integrate(func1, NULL, 0.0, t8);
  t11 = dvc_xc_integrate(func2, NULL, 0.0, t8);
  t12 = 0.1e1 / M_PI;
  t13 = t11 * t12;
  ...
  t21 = t20 * M_PI;
  t22 = t21 * t7;
  t23 = dvc_xc_integrate(func1, NULL, 0.0, t22);
  t25 = dvc_xc_integrate(func2, NULL, 0.0, t22);
  t26 = t25 * t12;
